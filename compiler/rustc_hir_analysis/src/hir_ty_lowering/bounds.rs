                ...
                match predicate_filter {
                    ...
                    | PredicateFilter::SelfAndAssociatedTypeBounds => {
                        ...
                        if let ty::AssocTag::Const = assoc_tag
                            && !find_attr!(self.tcx().get_all_attrs(assoc_item.def_id), AttributeKind::TypeConst(_))
                        {
                                ...
                                tcx.features().associated_const_equality()
                            {
                                ...
                                let err = self.dcx().span_delayed_bug(constraint.span, "use of trait associated const without `#[type_const]`");
                                return Err(err);
                            }
                        } else {
