...
impl<'mir, 'tcx: 'mir, M: Machine<'mir, 'tcx>> InterpCx<'mir, 'tcx, M> {
    ...
    pub(crate) fn copy_intrinsic(
        ...
        let layout = self.layout_of(src.layout.ty.builtin_deref(true).unwrap().0)?;
    ...
    pub(crate) fn write_bytes_intrinsic(
        ...
        let layout = self.layout_of(dst.layout.ty.builtin_deref(true).unwrap().0)?;
    ...
    pub(crate) fn raw_eq_intrinsic(
        ...
        let layout = self.layout_of(lhs.layout.ty.builtin_deref(true).unwrap().0)?;
